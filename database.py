...
def initialize_database():
    ...
    if cursor.fetchone()[0] == 0:
        ...
        VALUES (?, ?, ?, ?);
        """, [
            ("CIG-1001", "John Doe", 1850000.0, "Corporate Gold"),
            ("CIG-1002", "Mary Amina", 940000.0, "Retail Silver"),
            ("CIG-1003", "David Ochieng", 45000.0, "SME Bronze")
        ])
        ...
        VALUES (?, ?, ?);
        """, [
            ("Nairobi Premium Care", "Appendectomy", 150000.0),
            ("Nairobi Premium Care", "Cholecystectomy", 220000.0),
            ("Kajiado District Hospital", "Appendectomy", 85000.0),
